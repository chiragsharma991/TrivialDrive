...
package test.sample.android.trivialdrive;
...
import test.sample.android.trivialdrive.util.IabBroadcastReceiver;
import test.sample.android.trivialdrive.util.IabBroadcastReceiver.IabBroadcastListener;
import test.sample.android.trivialdrive.util.IabHelper;
import test.sample.android.trivialdrive.util.IabHelper.IabAsyncInProgressException;
import test.sample.android.trivialdrive.util.IabResult;
import test.sample.android.trivialdrive.util.Inventory;
import test.sample.android.trivialdrive.util.Purchase;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";
